  ...
  return (
    ...
    whileInView={{opacity: 1, y:0}}>
       <motion.div 
        ...
        <motion.button onClick={onClickHandler}  className=' sm:text-lg text-white bg-black/80 w-auto mt-8 px-12 py-2.5 flex items-center gap-3 rounded-full cursor-pointer'
        ...
        <div className='flex flex-wrap justify-center mt-16 gap-3'>
            {Array(6).fill('').map((item, index)=> (
                <img className='rounded hover:scale-110 transition-left duration-300 cursor-pointer max-sm:w-10'
